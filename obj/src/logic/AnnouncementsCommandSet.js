...
class AnnouncementsCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetAnnouncementsCommand() {
        return new pip_services3_commons_node_2.Command("get_announcements", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetRandomAnnouncementCommand() {
        return new pip_services3_commons_node_2.Command("get_random_announcement", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetAnnouncementByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_announcement_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('announcement_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeCreateAnnouncementCommand() {
        return new pip_services3_commons_node_2.Command("create_announcement", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateAnnouncementCommand() {
        return new pip_services3_commons_node_2.Command("update_announcement", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('announcement', new AnnouncementV1Schema_1.AnnouncementV1Schema()), (correlationId, args, callback) => {
            let announcement = args.get("announcement");
    ...
    makeDeleteAnnouncementByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_announcement_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('announcement_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let announcementId = args.getAsNullableString("announcement_id");
