# Configuration Guide <br/> Announcements Microservice

User announcements microservice configuration structure follows the 
...
Example:
```yaml
- descriptor: "pip-services-announcements:service:seneca:default:1.0"
  connection:
    protocol: "http"
    host: "0.0.0.0"
    port: 3000
