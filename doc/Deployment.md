# Deployment Guide <br/> Announcements Microservice
...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-announcements-node": "^1.0.*",
        ...
    }
}
```
...
var plugin = require('pip-services-announcements-node').AnnouncementsSenecaPlugin;
...
or by using [AnnouncementsSenecaClient](https://github.com/pip-services/pip-clients-announcements-node/NodeClientApiV1.md/#client_seneca)